...
export function Hero({ bankName, onStart }) {
  return (
    <Section>
      <Copy>
        <Badge>Student-built banking</Badge>
        <Title>{bankName}</Title>
        <Text>
          A fictional bank website made from reusable React components. Choose
          the name, arrange the dashboard, and make it feel like your own app.
        </Text>
        <Actions>
          <Button onClick={onStart}>Build the Dashboard</Button>
